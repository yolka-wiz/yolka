---
name: git-essentials
description: "Use when working with git: staging, committing, branching, merging, rebasing, stashing, or recovering from git mistakes. Essential Git commands and workflows for version control, branching, and collaboration."
version: 1.0.0
