...
description: Use when building, running, inspecting, or debugging Docker containers and images, writing Dockerfiles, or using docker-compose. Essential Docker commands and workflows for container management, image operations, and debugging.
version: 1.0.0
author: ported from ClawHub (arnarsson)
license: MIT
platforms: [linux, macos, windows]
metadata:
  hermes:
    tags: ['docker', 'containers', 'devops', 'images']
    related_skills: ['macos-containers']
---
